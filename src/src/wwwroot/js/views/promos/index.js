...
$(document).ready(function () {
    ...
    dataTable = $('#grid').DataTable({
        ...
        "columns": [
            ...
            {
                "data": function (data) {
                    var btnEdit = "<a class='btn btn-default btn-xs' onclick=ShowPopup('/Promos/AddEditIndex?id=" + data["id"] + "')><i class='fa fa-pencil' title='Edit'></i></a>";
                    ...
                    var btnView = "<a class='btn btn-default btn-xs' style='margin-left:5px' onclick=ShowPopup('/Promos/ViewPromosIndex?id=" + data["id"] + "')><i class='fa fa-external-link' title='More'></i></a>";
