...
$(document).ready(function () {
    ...
    dataTable = $('#grid').DataTable({
        ...
        "columns": [
            ...
            { "data": "description" },
            { "data": "public" },
            { "data": "availableForCourses" },
            { "data": "active" },
            {
                "data": function (data) {
                    var btnEdit = "<a class='btn btn-default btn-xs' onclick=ShowPopup('/Dashboard/AddEditIndex?id=" + data["id"] + "')><i class='fa fa-pencil' title='Edit'></i></a>";
